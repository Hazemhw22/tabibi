                  ...
                  {latestAppointments.map((apt: Record<string, unknown>) => {
                    ...
                    return (
                      <tr key={apt.id as string} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="py-4 text-gray-700">{String(apt.startTime)}</td>
                        <td className="py-4">
                          <Badge variant={config.variant}>{config.label}</Badge>
                        </td>
                        <td className="py-4 font-semibold text-gray-900">₪{Number(apt.fee)}</td>
                        <td className="py-4">
                ...
                <tbody className="divide-y divide-gray-50">
                  {txRows.map((tx) => (
                    <tr key={tx.id} className="hover:bg-gray-50 transition-colors">
                      <td className="py-2.5 sm:py-3 pr-4 text-gray-700">
                        {tx.date ? format(new Date(tx.date), "dd/MM/yyyy") : "—"}
                      </td>
                      <td className="py-2.5 sm:py-3 text-gray-900 font-medium">
                      ...
                      <td className="py-2.5 sm:py-3 text-gray-700">{tx.description}</td>
                      <td
                        className={`py-2.5 sm:py-3 font-semibold ${
