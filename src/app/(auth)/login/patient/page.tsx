      ...
      <CardContent className="pt-2">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="w-full">
            ...
            <div className="text-left">
              <Link href="/forgot-password/patient" className="text-sm text-blue-600 hover:underline">
                نسيت كلمة المرور؟
              </Link>
            </div>
          </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-base text-gray-600">
            ليس لديك حساب؟{" "}
            <Link href="/register/patient" className="text-blue-600 font-semibold hover:underline">
              إنشاء حساب مريض
            </Link>
          </p>
